...
While our **mobile** app is in progress we are starting to host our services [here](www.openspaceweb.org). It is static github pages site. However, we have set up a **Digital Ocean** project. Just have to figure out how to make our same api calls from a deployed react web app.
